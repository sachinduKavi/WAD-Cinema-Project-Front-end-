...
<?php 
    if(empty($_POST['email']) || empty($_POST['pass1']) || empty($_POST['pass2'])) {
        // Rediect backto register 01 page 
        header('Location: register01.php');
        exit();
    } else {
        // Can proceed further 
        if($_POST['pass1'] != $_POST['pass2']) {
            header('Location: register01.php?message=Password+dose+not+match');
            exit();
        }
    }
              ...
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form method="post" action="server/registerProcess.php">
                    ...
                    <div class="form-outline mb-4">
                      <input type="text" id="form2Example17" class="form-control form-control-lg" name="location"/>
                      <label class="form-label" for="form2Example17">Location</label>
                    </div>
  
                    <div class="form-outline mb-4">
                      <input type="number" id="form2Example27" class="form-control form-control-lg" name="noseats"/>
                      <label class="form-label" for="form2Example27">Number of seats</label>
                    </div>
                    
                    <div class="form-outline mb-4">
                      <input type="number" id="form2Example27" class="form-control form-control-lg" name="ticket-price"/>
